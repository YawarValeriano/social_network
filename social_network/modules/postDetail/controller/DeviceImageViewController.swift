...
protocol DeviceImageLibaryViewControllerDelegate {
...
class DeviceImageViewController: UIViewController {
    ...
    let collectionView: UICollectionView = {
        ...
        //register cell
        cv.register(PhotoCellForGallery.self, forCellWithReuseIdentifier: "PhotoCellForGallery")
        return cv
    }()

    var delegate: DeviceImageLibaryViewControllerDelegate?
...
extension DeviceImageViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        photos?.count ?? 0
    }

    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PhotoCellForGallery", for: indexPath) as? PhotoCellForGallery else { return UICollectionViewCell() }
...
class PhotoCellForGallery: UICollectionViewCell {
    var photo: UIImage? {
